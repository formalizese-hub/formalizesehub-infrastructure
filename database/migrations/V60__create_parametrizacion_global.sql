...
CREATE TABLE IF NOT EXISTS parametrizacion_global (
    ...
    detalle_concepto        VARCHAR(50)   DEFAULT NULL,
    detalle_concepto_ventas VARCHAR(50)   DEFAULT NULL,
    cuenta_ventas_id        VARCHAR(50)   DEFAULT NULL,
    cuenta_devolucion_venta_id VARCHAR(50) DEFAULT NULL,
